...
#* SCRIPT BODY
#*==========================================================================================
param([string]$task = "New-AutoUnattendIsoImages", [string]$configMode = "Debug", [string]$projectToBuild = "", [string]$buildCounter = "0", [string]$serverName = "$($env:computername)", [string]$environment = "Acceptance", [string]$runAsUserName = "$($env:username)", [string]$runAsUserPassword = "", [string]$forceDeploy = $false)
